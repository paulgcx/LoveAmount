@php
    // Guardar la clave de GET. Si es paul o si es vic.
    $savedKey = in_array(request()->get('key'), ['paul', 'vic']) 
        ? request()->get('key') 
        : null;
@endphp
...
<head>
    ...
    @vite(['resources/sass/tiempo-juntos.scss'])
</head>
<body>
    <div class="container">
        <div class="header">
        ...
        <a href="{{ route('love.index') }}{{ $savedKey ? '?key=' . $savedKey : '' }}" class="back-arrow">
